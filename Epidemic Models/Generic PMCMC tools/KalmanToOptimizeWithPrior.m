...
elseif strcmp(Parameters.Problem,'MarcFluPlusObs')
    subplot(2,1,1)
        ...
        title(Temp.LogLik)
        pause(0.001)
elseif or(strcmp(Parameters.Problem,'Marc1diff'),strcmp(Parameters.Problem,'Marc1diffb'))
        subplot(2,1,1)
        plot(Data.Observations(5,:),'g')
        hold on
        plot(Temp.PosteriorMeans(5,:))
        ...
        title(Temp.LogLik)
        pause(0.001)
elseif or(strcmp(Parameters.Problem,'Marc2diff'),strcmp(Parameters.Problem,'Marc2diffb'))
        subplot(4,1,1)
 ...
 elseif strcmp(Parameters.Problem,'Marc3diff')
        ...
        title(Temp.LogLik)
        pause(0.001)
   elseif strcmp(Parameters.Problem,'Marc4diff')
        subplot(6,1,1)
        plot(Data.Observations(9,:),'g')
        hold on
        plot(Temp.PosteriorMeans(9,:))
        ...
        plot(exp(Temp.PosteriorMeans(13,:)))
        subplot(6,1,6)
        plot(exp(Temp.PosteriorMeans(14,:)))
        title(Temp.LogLik)
        pause(0.001)
end
end