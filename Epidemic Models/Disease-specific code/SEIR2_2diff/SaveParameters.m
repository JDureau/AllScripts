...
Parameters.gammam1.PlotInv = 1;
Parameters.gammam1.Sample = 1;
Parameters.beta11init.Value = 1.44;
...
Parameters.beta22init.Value = 1.4;
...
Parameters.E1InitProp.Value = 2.2*10^(-5);
...
Parameters.I1InitProp.Value =  1.2*10^(-5);
...
Parameters.R1InitProp.Value = 0.16;
...
Parameters.E2InitProp.Value =  2.2*10^(-5);
...
Parameters.I2InitProp.Value =  1.2*10^(-5);
...
Parameters.R2InitProp.Value = 0.16;
...
Parameters.SigmaRW11.Value =0.11;
...
Parameters.SigmaRW22.Value = 0.08;
...
Parameters.adultsmult.Value = 0.1;
Parameters.adultsmult.Min = -10^14;
Parameters.adultsmult.Max = 10^14;
Parameters.adultsmult.Estimated = 0;
...
save([SavePath '/ParametersSEIR2_2diff.mat'])
