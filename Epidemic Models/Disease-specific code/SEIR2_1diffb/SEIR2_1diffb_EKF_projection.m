function Res = SEIR2_1diff_EKF_projection(Data,Model,m,Cov,NbIts,IndTime,Parameters)
    ...
    for IndDiscr = 1:NbIts
        ...
        beta22 = Parameters.adultsadultsadd.Value + Parameters.adultsadultsmult.Value*exp(mpred(11));
        ...
        Jacobian(2,11) = -Parameters.adultsadultsmult.Value*exp(mpred(11))*mpred(2)*mpred(6)/TotPop2-Parameters.adultsmult.Value*exp(mpred(11))*mpred(2)*mpred(5)/TotPop1;
        ...
        Jacobian(4,11) =  Parameters.adultsadultsmult.Value*exp(mpred(11))*mpred(2)*mpred(6)/TotPop2 + Parameters.adultsmult.Value*exp(mpred(11))*mpred(2)*mpred(5)/TotPop1;
