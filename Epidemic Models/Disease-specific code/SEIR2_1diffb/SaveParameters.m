...
Parameters.gammam1.PlotInv = 1;
Parameters.gammam1.Sample = 1;
Parameters.beta11init.Value = 0.437;
...
Parameters.beta22init.Value = 0.328;
...
Parameters.E1InitProp.Value = 1.16*10^(-5);
...
Parameters.E1InitProp.MaxLim = 0.001;
...
Parameters.I1InitProp.Value = 0.8*10^(-5);
...
Parameters.I1InitProp.MaxLim = 0.001;
...
Parameters.R1InitProp.Value = 0.08;
Parameters.R1InitProp.Min = 0;
Parameters.R1InitProp.Max = 0.30;
Parameters.R1InitProp.MinLim = 0.08;
...
Parameters.E2InitProp.Value = 1.6*10^(-5);
...
Parameters.E2InitProp.MaxLim = 0.001;
...
Parameters.I2InitProp.Value = 1.3*10^(-5);
...
Parameters.I2InitProp.MaxLim = 0.001;
...
Parameters.SigmaRW11.Value =0.19;
...
Parameters.adultsadd.Value = 0.17;
...
Parameters.adultsmult.Value = 1.2;
...
Parameters.adultsadultsadd.Value = 0.17;
Parameters.adultsadultsadd.Min = -10^14;
Parameters.adultsadultsadd.Max = 10^14;
Parameters.adultsadultsadd.Estimated = 1;
Parameters.adultsadultsadd.Sample = 0;
Parameters.adultsadultsadd.TransfType = 'Log';
Parameters.adultsadultsmult.Value = 1.2;
Parameters.adultsadultsmult.Min = -10^14;
Parameters.adultsadultsmult.Max = 10^14;
Parameters.adultsadultsmult.Estimated = 1;
Parameters.adultsadultsmult.Sample = 0;
Parameters.adultsadultsmult.TransfType = 'Log';
Parameters.kidsmult.Value = 0.97;
...
save([SavePath '/ParametersSEIR2_1diffb.mat'])
