function Res = SEIR2_1diffb_SMC_projection(Variables,IndIt,NbIts,Data,Parameters,Path)
    ...
    rands = randn(1,Parameters.NbParticules ,NbIts);
    ...
    for IndDiscr = 1:NbIts
        ...
        beta22 = Parameters.adultsadultsadd.Value + Parameters.adultsadultsmult.Value*exp(TempVariables(:,11));
        %S
