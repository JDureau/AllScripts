function Res = SEIR2_1diff_SMC_projection(Variables,IndIt,NbIts,Data,Parameters,Path)
    ...
    for IndDiscr = 1:NbIts
        ...
        TempVariables(:,11) = TempVariables(:,11) + sqrt(ComputationTStep)*SigmaRW11*rands(:,IndDiscr);
