...
Cov = cov(Res3.TransfThetas(1:end-1,:)');
...
SEIRModel.LikFunction = 'normpdf(coeff*Data.Observations(5,IndTime),Variables(:,5),Variables(:,5)*Parameters.SigmaObs.Value)';
ResKal = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,15000);


Cov = cov(ResKal.TransfThetas');
Parameters.G = Cov^-1;
ResKal2 = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,30000);

Cov = eye(6,6);
Parameters.G = Cov^-1;
Parameters.ModelType='SMC';
ResSMCId = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);

Cov = cov(ResKal2.TransfThetas');
Parameters.G = Cov^-1;
Parameters.ModelType='SMC';
ResSMCKals = {};
ResSMCKals{1} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);
ResSMCKals{2} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);
ResSMCKals{3} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);
ResSMCKals{4} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);
ResSMCKals{5} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);

Cov = cov(ResSMCKals{1}.TransfThetas');
Parameters.G = Cov^-1;
Parameters.ModelType='SMC';
ResSMCOpt = {};
ResSMCOpts{1} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);
ResSMCOpts{2} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);
ResSMCOpts{3} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);
ResSMCOpts{4} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);
ResSMCOpts{5} = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,10000);


Kals = [];
Opts = [];
for i  = 1:5
    Kals(i) = min(ResSMCKals{i}.ESS);
    Opts(i) = min(ResSMCOpts{i}.ESS);
end
Kals
Opts
...
SEIRModel.LikFunction = 'normpdf(coeff*Data.Observations(5,IndTime),Variables(:,5),Variables(:,5)*Parameters.SigmaObs.Value)';
Parameters.ModelType='SMC';
ResSMC = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,2000);


PlotPosteriors(ResKal,ResSMC)
...
Parameters.SaveSpace = 1;
Parameters.Color = 1;
Res3 = RunEstimationMethod(Data, SEIRModel,Parameters,TempPar,50000);
