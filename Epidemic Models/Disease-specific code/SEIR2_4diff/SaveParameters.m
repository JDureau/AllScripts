...
Parameters.beta12init.Init = 1;
Parameters.beta12init.Sample = 0;
Parameters.beta21init.Value = 1;
Parameters.beta21init.Min = -10^14;
Parameters.beta21init.Max = 10^14;
Parameters.beta21init.Estimated = 1;
Parameters.beta21init.TransfType = 'Log';
Parameters.beta21init.Init = 1;
Parameters.beta21init.Sample = 0;
...
Parameters.SigmaRW12.Value = 0.065;
Parameters.SigmaRW12.Min = -10^14;
Parameters.SigmaRW12.Max = 10^14;
Parameters.SigmaRW12.Estimated = 1;
Parameters.SigmaRW12.Sample = 0;
Parameters.SigmaRW12.TransfType = 'Log';
Parameters.SigmaRW21.Value = 0.065;
Parameters.SigmaRW21.Min = -10^14;
Parameters.SigmaRW21.Max = 10^14;
Parameters.SigmaRW21.Estimated = 1;
Parameters.SigmaRW21.Sample = 0;
Parameters.SigmaRW21.TransfType = 'Log';
Parameters.adultsmult.Value = 0.2;
...
save([SavePath '/ParametersSEIR2_4diff.mat'])
