...
%             beta = base + (mu-base)/(1+mtemp(9));
        ...
        mpred(5) = mpred(5) + ( MuMm1^-1*(TotM) + Alpham1^-1*mtemp(6) - BetaFM*CM*(1-eHIV*beta)*mtemp(5)*(CF1*TotF1/(CF2*TotF2+CF1*TotF1)*mtemp(2)./TotF1+CF2*TotF2/(CF2*TotF2+CF1*TotF1)*mtemp(4)/TotF2)-MuMm1^-1*mtemp(5))*TStep;
        mpred(6) = mpred(6) + ( BetaFM*CM*(1-eHIV*beta)*mtemp(5)*(CF1*TotF1/(CF2*TotF2+CF1*TotF1)*mtemp(2)/TotF1+CF2*TotF2/(CF2*TotF2+CF1*TotF1)*mtemp(4)/TotF2) - (MuMm1^-1+Alpham1^-1)*mtemp(6))*TStep;
        ...
        Jacobian(5,1) = 0;
        Jacobian(5,2) =  - BetaFM*CM*(1-eHIV*beta)*mtemp(5)*(CF1*TotF1./(CF2*TotF2+CF1*TotF1)./TotF1);
        Jacobian(5,3) = 0;
        Jacobian(5,4) =  - BetaFM*CM*(1-eHIV*beta)*mtemp(5)*(CF2*TotF2./(CF2*TotF2+CF1*TotF1)./TotF2);
        Jacobian(5,5) =  - BetaFM*CM*(1-eHIV*beta)*(CF1*TotF1./(CF2*TotF2+CF1*TotF1)*mtemp(2)./TotF1+CF2*TotF2./(CF2*TotF2+CF1*TotF1)*mtemp(4)./TotF2)-MuMm1^-1;
        Jacobian(5,6) =    Alpham1^-1;
        Jacobian(5,7) = 0;
        Jacobian(5,8) = 0;
        Jacobian(5,9) =  - BetaFM*CM*(-eHIV*betader)*mtemp(5)*(CF1*TotF1./(CF2*TotF2+CF1*TotF1)*mtemp(2)./TotF1+CF2*TotF2./(CF2*TotF2+CF1*TotF1)*mtemp(4)./TotF2);
        Jacobian(6,1) = 0;
        Jacobian(6,2) =  BetaFM*CM*(1-eHIV*beta)*mtemp(5)*(CF1*TotF1./(CF2*TotF2+CF1*TotF1)./TotF1) ;
        Jacobian(6,3) = 0;
        Jacobian(6,4) =  BetaFM*CM*(1-eHIV*beta)*mtemp(5)*(CF2*TotF2./(CF2*TotF2+CF1*TotF1)./TotF2) ;
        Jacobian(6,5) =  BetaFM*CM*(1-eHIV*beta)*(CF1*TotF1./(CF2*TotF2+CF1*TotF1)*mtemp(2)./TotF1+CF2*TotF2./(CF2*TotF2+CF1*TotF1)*mtemp(4)./TotF2) ;
        Jacobian(6,6) =  - (MuMm1^-1+Alpham1^-1);
        Jacobian(6,7) = 0;
        Jacobian(6,8) = 0;
        Jacobian(6,9) =  BetaFM*CM*(-eHIV*betader)*mtemp(5)*(CF1*TotF1./(CF2*TotF2+CF1*TotF1)*mtemp(2)./TotF1+CF2*TotF2./(CF2*TotF2+CF1*TotF1)*mtemp(4)./TotF2);
