...
temp = load(['ParametersBellary.mat']);
ParametersBellary = temp.Parameters;

temp = load(['ParametersEastGodavry.mat']);
ParametersEastGodavry = temp.Parameters;

temp = load(['ParametersGuntur.mat']);
ParametersGuntur = temp.Parameters;

temp = load(['ParametersHyderabad.mat']);
ParametersHyderabad = temp.Parameters;

temp = load(['ParametersVisag.mat']);
ParametersVisag = temp.Parameters;

temp = load(['ParametersWarangal.mat']);
ParametersWarangal = temp.Parameters;

temp = load(['ParametersYevatmal.mat']);
ParametersYevatmal = temp.Parameters;

temp = load(['ParametersShimoga.mat']);
